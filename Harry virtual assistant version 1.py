...
def listen():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            respond("Pardon me sir,please say that again")
            return "None"
...
def digital_assistant(data):
    try:
        if "how are you" in data:
            ...
            engine.say("I am Harry virtual assistant, I am programmed to do minor tasks like system monitoring, profiling,"
            ...
            respond("I was built by Vicente Riquelme")
            return
            ...
            webbrowser.get('chrome').open_new(url)
            respond("Here are some headlines from the Times of the world,Happy reading")
            time.sleep(5)
            return
                
        elif "weather" in data:
            data=data.split(" ")
            api_key = "0cb2f4a351d2a59fcda028b5c144be66"
            ...
            if x["cod"] != "404":
                ...
                respond(" Temperature in Celcius unit is " +
...
if __name__=="__main__":
    ...
    wishme()
    respond("Harry is at your service")
    while True:
